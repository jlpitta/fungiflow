...
Neither tool alone is reliable at the low k-mer coverage typical of these test
...
saccharomyces_cerevisiae_synthetic/heterozygous test datasets, see the
"fungiflow" Notion doc, section 7). So heterozygosity is only called when BOTH
signals agree: the AB smudge is a majority of the mass, AND Smudgeplot's
inferred coverage is close to GenomeScope2's kmercov.
"""
import argparse
import json
import re
